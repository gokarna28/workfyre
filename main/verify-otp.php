        ...
        <form class="items-center justify-center">
            ...
            <div>
                <div class="flex flex-col justify-center gap-5 mb-5">
                    ...
                    <button type="submit"
                        class="hover:bg-stone-900 hover:text-white text-xl font-medium border px-4 py-2 rounded-full">Verify OTP</button>
                </div>
                <div>
                    <p>Go back to <a href="register.php" class="text-blue-400">Register</a> / <a href="login.php" class="text-blue-400">Login</a></p>
                </div>
            </div>
        </form>
    </div>
