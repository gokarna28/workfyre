    ...
    <form class="items-center justify-center">
        ...
        <div>
            <div class="flex flex-col justify-center gap-5 mb-5">
                ...
                <button type="submit" class="hover:bg-stone-900 hover:text-white text-xl font-medium border px-4 py-2 rounded-lg">Login</button>
            </div>
            <div>
                <p>Don't have account? <a href="<?php echo HOMEPAGE_URL?>/main/register.php" class="text-blue-400">Register</a></p>
            </div>
        </div>
    </form>
</div>
